...
{	
	...
	//exit button
	m_buttons.push_back(Button(sf::Vector2f(WINDOW_X * 157/160, WINDOW_Y/30), sf::Vector2f(WINDOW_X / 64, WINDOW_X / 64) , m_resources.getButtonName(5), &cir[2]));// , &m_resources.getButtonTextures(i)));
}
