...
{
	m_buttons.push_back(Button(sf::Vector2f(WINDOW_X*4/10, WINDOW_Y*2/3), sf::Vector2f(150, 150), BACK_TO_MENU, &m_resources.getMenuButtonTexture(5),
		std::move(std::make_unique<NextStateCommand>(controller, GameStates::MENU_S))));

	m_buttons.push_back(Button(sf::Vector2f(WINDOW_X *6/10, WINDOW_Y * 2 / 3), sf::Vector2f(150, 150), NEW_GAME, &m_resources.getMenuButtonTexture(6),
