...
bool AirJump::m_registerit = GameEnityFactory<AirJump>::registerit(AIR_JUMP_C,
	[](std::unique_ptr<b2World>& world, sf::Color color, sf::Vector2f position) -> std::unique_ptr<AirJump>
	{
