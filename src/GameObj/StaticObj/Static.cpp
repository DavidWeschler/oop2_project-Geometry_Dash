	...
	sf::Vector2f boxPosition, sf::Vector2f boxShapeSize, bool sensor)
{
	...
	bodyDef.position.Set(getPosition().x / 30, getPosition().y / 30);	// need?
	...
	//else if (getColor() == LONG_SPIKE_C || getColor() == DOWN_LONG_SPIKE_C)
	//{
	//	bodyDef.position.Set((4*60+getPosition().x) / 30, getPosition().y / 30);
	//	boxShape.SetAsBox(8.0f, 0.4f);
	//}
	//else
	//{
	...
	//{
	//	fixtureDef.isSensor = false;	//default
	//}
	//else
	//{
